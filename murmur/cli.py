"""Command-line interface for Murmur (import package: murmur).
...
from murmur.application.workflow_planner import TEMPLATES, plan_from_task
...
if __name__ == "__main__":
    # Lets `python -m murmur.cli` behave like the installed `murmur` command.
    app()
