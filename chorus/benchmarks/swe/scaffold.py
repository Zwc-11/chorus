...
(SWE-agent, OpenHands, Aider, ...), implement :class:`~chorus.benchmarks.swe.types.PatchModel`
...
from chorus.benchmarks.swe.types import ModelResponse, PatchModel, ScaffoldOutput
