...
This is the integrated counterpart to the batch :mod:`chorus.benchmarks.swe`
...
``JudgePort`` that runs the tests (see :class:`chorus.benchmarks.swe.judge.SweBenchJudge`),
...
from chorus.benchmarks.swe.types import PatchModel
